...
public final class noticebill_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tvar validate = $(\"#noticebillSave\").form('validate');\r\n");
      out.write("\t\t\tif(validate) {\r\n");
      out.write("\t\t\t\t$(\"#noticebillSave\").submit();\r\n");
      out.write("\t\t\t}else {\r\n");
      out.write("\t\t\t\t$.messager.alert(\"Error\",\"Please input all necessary material\",\"error\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t\t<form id=\"noticebillSave\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      ...
      out.write("\t\t\t\t\t<td><input name=\"telephone\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>客户编号:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"customerId\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>客户姓名:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"customerName\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>联系人:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"delegater\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr class=\"title\">\r\n");
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>品名:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"product\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>件数:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"num\" type=\"text\" class=\"easyui-numberbox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>重量:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"weight\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>体积:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"volume\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>取件地址</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\"><input name=\"pickaddress\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" size=\"144\"/></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>到达城市:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"arrivecity\" type=\"text\" class=\"easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>预约取件时间:</td>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"pickdate\" class=\"easyui-datebox\"\r\n");
      out.write("\t\t\t\t\t\t data-options=\"editable:false, required:true\"/></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>备注:</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\"><textarea name=\"remark\" rows=\"5\" cols=\"80\" type=\"text\" class=\"easyui-validatebox\"\r\n");
