...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidezone_listUnascCustomer\", function(data) {\r\n");
      ...
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidezone_listHsascCustomer\", {'id' : selected.id}, function(data) {\r\n");
      out.write("\t\t\t\t$(data).each(function() {\r\n");
      out.write("\t\t\t\t\tvar option = \"<option value=\"+ this.id +\">\"+ this.name + \"(\" + this.address + \")\"+\"</option>\";\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\t$.messager.alert(\"Error\",\"Please choose the zone you want to manipulate\",\"error\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//工具栏\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidezone_pageQueryDecideZone\",\r\n");
      ...
      out.write("\t\t\t$(\"#associationSelect option\").attr(\"selected\",true);\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\tvar validated = $(\"#decideZoneSU\").form('validate');\r\n");
      out.write("\t\tif(validated) {\r\n");
      out.write("\t\t\t$(\"#decideZoneSU\").submit();\r\n");
      out.write("\t\t} else{\r\n");
      out.write("\t\t\t$.messager.alert(\"Format Error\", \"Please input all the necessary field\", \"error\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<a id=\"save\" icon=\"icon-save\" href=\"javascript:saveOrUpdate()\" class=\"easyui-linkbutton\" plain=\"true\" >保存</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form id=\"decideZoneSU\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidezone_saveOrUpdate\" method=\"post\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/subarea_ajaxnodzlist',fitColumns:true,singleSelect:false\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>  \r\n");
      out.write("\t\t\t\t\t\t\t        <tr>  \r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidezone_associate\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
