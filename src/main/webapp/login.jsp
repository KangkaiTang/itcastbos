...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<s:form namespace="/" action="login" id="loginform" name="loginform"
					method="post" cssClass="niceform" target="_top"> <!-- target可以防止主页嵌套 -->
					<s:actionerror/>
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						style="margin-top: 5px;">
						<s:textfield id="loginform:idInput" name="username"
							cssClass="loginFormTdIpt" maxlength="50" tabindex="1"
							title="请输入帐号"></s:textfield>
						<label for="idInput" class="placeholder" id="idPlaceholder">帐号：</label>
					</div>
					<div class="forgetPwdLine"></div>
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<s:password id="loginform:pwdInput" cssClass="loginFormTdIpt"
