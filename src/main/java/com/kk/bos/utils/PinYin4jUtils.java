...
public class PinYin4jUtils {
	...
	public static String getHeader(String src) {
		String header = "";
		String[] str = getHeadByString(src);
	...
	public static String getNamePinyin(String src) {
		String fullNamePinyin = hanziToPinyin(src.substring(0, src.length()-1), "");
