...
public class Subarea  implements java.io.Serializable {
    ...
    /** full constructor */
    public Subarea(String id, DecideZone decideZone, Region region, String addresskey, String startnum, String endnum, String single, String position) {
        this.id = id;
